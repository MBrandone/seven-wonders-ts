...
import {Card, CivilianCard, MilitaryCard, ScienceCard} from "./card.value-object";
...
export const bassinArgileux1 = new Card('Bassin Argileux', CardType.RAW_MATERIAL, 3, 1);
export const bassinArgileux2 = new Card('Bassin Argileux', CardType.RAW_MATERIAL, 5, 1);
...
export const fosseArgileuse = new Card('Fosse Argileuse', CardType.RAW_MATERIAL, 3, 1);
export const exploitationForestiere = new Card('Exploitation Forestière', CardType.RAW_MATERIAL, 3, 1);
...
export const briquetterie1 = new Card('Briquetterie', CardType.RAW_MATERIAL, 3, 2);
export const briquetterie2 = new Card('Briquetterie', CardType.RAW_MATERIAL, 4, 2);
...
export const metierATisser1 = new Card('Métier à Tisser', CardType.MANUFACTURED_GOOD, 3, 1);
export const metierATisser2 = new Card('Métier à Tisser', CardType.MANUFACTURED_GOOD, 6, 1);
...
export const metierATisser3 = new Card('Métier à Tisser', CardType.MANUFACTURED_GOOD, 3, 2);
export const metierATisser4 = new Card('Métier à Tisser', CardType.MANUFACTURED_GOOD, 5, 2);
...
export const scriptorium1 = new ScienceCard('Scriptorium', 3, 1, ScienceSymbol.TABLET);
export const scriptorium2 = new ScienceCard('Scriptorium', 4, 1, ScienceSymbol.TABLET);
...
export const officine1 = new ScienceCard('Officine', 3, 1, ScienceSymbol.COMPASS);
export const officine2 = new ScienceCard('Officine', 5, 1, ScienceSymbol.COMPASS);

export const laboratoire1 = new ScienceCard('Laboratoire', 3, 2, ScienceSymbol.WHEEL);
export const laboratoire2 = new ScienceCard('Laboratoire', 5, 2, ScienceSymbol.WHEEL);
export const bibliotheque1 = new ScienceCard('Bibliothèque', 3, 2, ScienceSymbol.TABLET);
export const bibliotheque2 = new ScienceCard('Bibliothèque', 6, 2, ScienceSymbol.TABLET);
...
export const dispensaire1 = new ScienceCard('Dispensaire', 3, 2, ScienceSymbol.COMPASS);
export const dispensaire2 = new ScienceCard('Dispensaire', 4, 2, ScienceSymbol.COMPASS);

export const academie1 = new ScienceCard('Académie', 3, 3, ScienceSymbol.COMPASS);
export const academie2 = new ScienceCard('Académie', 7, 3, ScienceSymbol.COMPASS);
export const observatoire1 = new ScienceCard('Observatoire', 3, 3, ScienceSymbol.WHEEL);
export const observatoire2 = new ScienceCard('Observatoire', 7, 3, ScienceSymbol.WHEEL);
export const universite1 = new ScienceCard('Université', 3, 3, ScienceSymbol.TABLET);
export const universite2 = new ScienceCard('Université', 4, 3, ScienceSymbol.TABLET);
...
export const comptoirOuest1 = new Card('Comptoir Ouest', CardType.COMMERCIAL, 3, 1);
export const comptoirOuest2 = new Card('Comptoir Ouest', CardType.COMMERCIAL, 7, 1);
...
export const caravansarai1 = new Card('Caravansérail', CardType.COMMERCIAL, 3, 2);
export const caravansarai2 = new Card('Caravansérail', CardType.COMMERCIAL, 5, 2);
export const caravansarai3 = new Card('Caravansérail', CardType.COMMERCIAL, 6, 2);
...
export const chambreDeCommerce1 = new Card('Chambre de commerce', CardType.COMMERCIAL, 4, 3);
export const chambreDeCommerce2 = new Card('Chambre de commerce', CardType.COMMERCIAL, 6, 3);
...
// Guildes
export const guildeDesTravailleurs1 = new Card('Guilde des travailleurs', CardType.GUILD, 3, 3);
export const guildeDesArtisans1 = new Card('Guilde des artisans', CardType.GUILD, 3, 3);
export const guildeDesCommercants1 = new Card('Guilde des commerçants', CardType.GUILD, 3, 3);
export const guildeDesPhilosophes1 = new Card('Guilde des philosophes', CardType.GUILD, 3, 3);
export const guildeDesEspions1 = new Card('Guilde des espions', CardType.GUILD, 3, 3);
export const guildeDesArmateurs1 = new Card('Guilde des armateurs', CardType.GUILD, 3, 3);
export const guildeDesScientifiques1 = new Card('Guilde des scientifiques', CardType.GUILD, 3, 3);
export const guildeDesMagistrats1 = new Card('Guilde des magistrats', CardType.GUILD, 3, 3);
export const guildeDesBatisseurs1 = new Card('Guilde des bâtisseurs', CardType.GUILD, 3, 3);
export const guildeDesDecorateurs1 = new Card('Guilde des décorateurs', CardType.GUILD, 3, 3);
