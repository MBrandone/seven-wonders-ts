...
export const comptoirEst1 = new Card("Comptoir Est", CardType.COMMERCIAL, 3, 1, [], 0);
export const comptoirEst2 = new Card("Comptoir Est", CardType.COMMERCIAL, 7, 1, [], 0);
...
// AGE 2
export const forum1 = new Card("Forum", CardType.COMMERCIAL, 3, 2, [Resource.ARGILE, Resource.ARGILE], 0);
export const forum2 = new Card("Forum", CardType.COMMERCIAL, 6, 2, [Resource.ARGILE, Resource.ARGILE], 0);
export const forum3 = new Card("Forum", CardType.COMMERCIAL, 7, 2, [Resource.ARGILE, Resource.ARGILE], 0);
...
export const arene1 = new Card("Arène", CardType.COMMERCIAL, 3, 3, [Resource.ARGILE, Resource.ARGILE, Resource.MINERAI], 0);
export const arene2 = new Card("Arène", CardType.COMMERCIAL, 5, 3, [Resource.ARGILE, Resource.ARGILE, Resource.MINERAI], 0);
