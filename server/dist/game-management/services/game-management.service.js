...
exports.GameManagementService = void 0;
...
let GameManagementService = class GameManagementService {
    ...
    async createGame(maxPlayers) {
        ...
        const game = game_entity_1.Game.create(id, createdAt, maxPlayers, []);
